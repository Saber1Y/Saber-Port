          ...
          <div className='flex items-center justify-between  w-full'>
            <div className='w-full lg:w-2/3'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                <Link type="button" class="text-white bg-gradient-to-r to-emerald-600 from-sky-400  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" href="mailto:akintobiayodeji1@gmail.com" target={'_blank'} >
