    ...
    <>
      ...
      <section className="flex justify-evenly">
        <div className="flex flex-col w-1/2 mx-10 mt-20">
          ...
          <p className="leading-loose text-1xl">
            Feel free to reach out to me for any inquiries, collaborations, or
            questions you may have. Whether you're interested in working
            together, have feedback to share, or just want to say hello, I'd
            love to hear from you. Your messages are important to me, and I'll
            do my best to respond promptly. Let's connect and start a
            conversation!
          </p>
          <div className="flex flex-col items-start mt-5 cursor-pointer">
            ...
            <div className="flex items-center">
              ...
              <Link href="mailto:ayodejjiakintobi1@gmail.com">
                ayodejiakintobi1@gmail.com
              </Link>
            </div>
          </div>
        </div>
          ...
          >
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <label
                  htmlFor="message"
                  className="block text-sm font-semibold leading-6 text-gray-900 focus:outline-none"
                >
                  Message
                </label>
                <div className="mt-2.5">
